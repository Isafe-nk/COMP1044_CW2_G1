...
<html>
	<head>
		...
		<script>
			...
			function validateForm(){
				...
				var category = document.getElementById("categoryType").vaule;
				...
				if (bookTitle == "") {
					...
					alert("Please key in book publication.");
					return false;
				}else if (publisherName == "") {
					alert("Please key in publisher name.");
					return false;
				}else if (isbn == "") {
					...
					alert("Please select a valid book status.");
					return false;
				}else  {
					return true;
				}
	...
	<div class="wrapper">
		...
		<div class="top_nav">
			...
			<div class="right">
				<ul>
				<li><a href="conn/destroy.php" onclick=" return logoutconfirm()">LOGOUT</a></li>
				</ul>
			</div>
		</div>
